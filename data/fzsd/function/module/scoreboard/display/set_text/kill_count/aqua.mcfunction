...
scoreboard objectives modify fzsd.module.scoreboard.display.kill_count displayname {"text": "击杀榜", "color": "aqua"}
team modify fzsd.module.scoreboard.display.kill_count color aqua
team modify fzsd.module.scoreboard.display.kill_count displayName {"text": "击杀榜", "color": "aqua"}