...
execute if data storage fzsd:install fzsd.module{scoreboard:1b} if score @s fzsd.event.afk.idle_ticks matches 200.. run function #fzsd:module/scoreboard/assign/scoreboard/afk_time
